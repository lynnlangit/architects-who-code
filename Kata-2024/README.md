...
Hospital nurses and doctors need timely patient status in order to provide the highest quality patient care. Several **gaps exist** in the current US hospital market.  The first step in designing and building a new solution to address these gaps is to understand the [current hospital state](https://github.com/lynnlangit/architects-who-code/blob/main/Kata-2024/domain-info/hospitals.md) and challenges faced by medical professionals and those who support them.
